...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.receiveSearchGiphys = exports.fetchSearchGiphys = exports.RECEIVE_SEARCH_GIPHYS = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GiphysSearchContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_giphys_search2.default);
	
	exports.default = GiphysSearchContainer;
	...
	var GiphysSearch = function (_React$Component) {
	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    value: function handleSubmit(e) {
	      ...
	      this.props.fetchSearchGiphys(searchTerm).then(this.setState({ searchTerm: "" }));
	    }
	  }, {
	    key: 'handleChange',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_giphys_index2.default, {
	...
	var GiphysIndex = function GiphysIndex(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    giphys.map(function (giphy, idx) {
	      return _react2.default.createElement(_giphys_index_item2.default, {
	        key: idx,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GiphysIndexItem = function GiphysIndexItem(_ref) {
	  var giphyUrl = _ref.giphyUrl;
	
	  return _react2.default.createElement(
	    "li",
	    { className: "giphy-li" },
	    _react2.default.createElement("img", { src: giphyUrl })
	  );
	};
